...
public class c7_ErrorHandling extends ErrorHandlingBase {
    ...
    public void under_the_rug() {
        Flux<String> messages = messageNode().onErrorResume(th -> Mono.empty());
    ...
    public void have_a_backup() {
        Flux<String> messages = messageNode().onErrorResume(th -> backupMessageNode());
    ...
    public void error_reporter() {
        Flux<String> messages = messageNode()
                .onErrorResume(th -> errorReportService(th).then(Mono.error(th)));
